   ...
   <section id="portfolio" class="portfolio">
    <div class="container" data-aos="fade-up">
      ...
      <div class="section-title">
        <h2>Kost</h2>
        <h3>rumah <span>Kost</span></h3>
        <p>Menyediakan kos-kosan untuk di wilayang jogjakarta dan sekitarnya nyaman dan terjamin murah untuk dompet kalian</p>
        <a href="categories" class="btn-get-started scrollto">Cari Kosan</a>
      </div>
      ...
      <div class="row portfolio-container" data-aos="fade-up" data-aos-delay="200">
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <img src="img/rumah4.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Card 2</h4>
            <p>Card</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-web">
          <img src="img/rumah5.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Web 2</h4>
            <p>Web</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-app">
          <img src="img/rumah6.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>App 3</h4>
            <p>App</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <img src="img/rumah7.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Card 1</h4>
            <p>Card</p>
        ...
        <div class="col-lg-4 col-md-6 portfolio-item filter-card">
          <img src="img/rumah8.jpg" class="img-fluid" alt="">
          <div class="portfolio-info">
            <h4>Card 3</h4>
            <p>Card</p>
