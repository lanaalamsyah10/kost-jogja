...
<<<<<<< HEAD
            <h1>Welcome to <span>Kos Jogja</span></h1>
            <h2>Solusi Terbaik Untuk Liburan Anda</h2>
            <div class="d-flex">
                <a href="#about" class="btn-get-started scrollto">Pesan</a>
=======
            <h1>Selamat Datang Di <span>Kost Jogja</span></h1>
            <h2>Aplikasi Anak Kos Yogyakarta. 🏡 Cari & pesan kamar kost impianmu di KostJogja pakai Booking Langsung 📱
...
>>>>>>> a6505bf521eff32665a3b5fc05ab6e3edd903ae1
                <a href="https://www.youtube.com/watch?v=jDDaplaOz7Q" class="glightbox btn-watch-video"><i
                        class="bi bi-play-circle"></i><span>DAFTAR</span></a>
            </div>
        </div>
    </section><!-- End Hero -->
@endsection
